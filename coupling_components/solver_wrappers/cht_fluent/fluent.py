...
def create(parameters):
    return SolverWrapperCHTFluent(parameters)


class SolverWrapperCHTFluent(SolverWrapper):
    ...
    accepted_in_var = list(accepted_variables_cht['in'].keys())
    accepted_out_var = list(accepted_variables_cht['out'].keys())
