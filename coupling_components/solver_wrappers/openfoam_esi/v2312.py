from coconut.coupling_components.solver_wrappers.openfoam_esi.openfoam_esi import SolverWrapperOpenFoamESI
from coconut import tools
from coconut.coupling_components.solver_wrappers.openfoam_esi import openfoam_esi_io as of_io
import os

def create(parameters):
    return SolverWrapperOpenFOAM2312(parameters)

class SolverWrapperOpenFOAM2312(SolverWrapperOpenFoamESI):
    version = '2312'
    ...
    def read_face_centres(self, boundary_name, nfaces):
        filename_x = os.path.join(self.working_directory, "0/Cx")
        filename_y = os.path.join(self.working_directory, "0/Cy")
        filename_z = os.path.join(self.working_directory, "0/Cz")
