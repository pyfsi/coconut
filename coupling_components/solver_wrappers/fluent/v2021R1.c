...
return;
  ...
  /*--------------------*/
 /* move_zone aileron_left */
/*--------------------*/

DEFINE_ZONE_MOTION(move_zone_aileron_left,omega,axis,origin,velocity,time,dtime) {

    Message0("\n\nRunning UDF 'move_zone_aileron_left.'\n");
    ...
    host_to_node_int_1(timestep);
#if !RP_NODE
    sprintf(file_name_zone, "move_zone_aileron_left_update_timestep%i.dat",timestep
            );
#else
    struct stat st = {0};
    ...
    sprintf(file_name_zone, "|TMP_DIRECTORY_NAME|/move_zone_aileron_left_update_timestep%i.dat",timestep
            );
    host_to_node_sync_file("|TMP_DIRECTORY_NAME|");
#endif /* !RP_NODE */
...
Message0("\n\nFinished UDF 'move_zone_aileron_left.'\n");
return;
}


  /*--------------------*/
 /* move_zone aileron_right */
/*--------------------*/

DEFINE_ZONE_MOTION(move_zone_aileron_right,omega,axis,origin,velocity,time,dtime) {

    Message0("\n\nRunning UDF 'move_zone_aileron_right.'\n");
    ...
    host_to_node_int_1(timestep);
#if !RP_NODE
    sprintf(file_name_zone, "move_zone_aileron_right_update_timestep%i.dat",timestep
            );
#else
    struct stat st = {0};
    ...
    sprintf(file_name_zone, "|TMP_DIRECTORY_NAME|/move_zone_aileron_right_update_timestep%i.dat",timestep
            );
    host_to_node_sync_file("|TMP_DIRECTORY_NAME|");
#endif /* !RP_NODE */
