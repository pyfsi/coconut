...
class SolverWrapperCombined(Component):
    def __init__(self, parameters):
        ...
        self.explicit_timestep_start = self.settings.get('explicit_timestep_start', 0)
    ...
    def initialize(self):
        ...
        for sol_wrapper in self.mapped_solver_wrapper_list:
            ...
            self.other_interface_outputs.append(sol_wrapper.get_interface_output().copy())
