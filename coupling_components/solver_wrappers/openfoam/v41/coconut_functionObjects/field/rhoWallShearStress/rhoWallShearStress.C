...
void Foam::functionObjects::rhoWallShearStress::calcShearStress
(
    const fvMesh& mesh,
    ...
    patchSet_()
{
    ...
    volVectorField* rhoWallShearStressPtr
    (
        new volVectorField
        (
            IOobject
    ...
    mesh.objectRegistry::store(rhoWallShearStressPtr);
...
bool Foam::functionObjects::rhoWallShearStress::execute()
{
    ...
    volVectorField& rhoWallShearStress =
    ...
    calcShearStress(mesh, Reff(), rhoWallShearStress);
...
bool Foam::functionObjects::rhoWallShearStress::write()
{
    ...
    Log << type() << " " << name() << " write:" << nl
        << "    writing field " << rhoWallShearStress.name() << endl;

    rhoWallShearStress.write();
