...
#include "coconut_timeVaryingMappedFvPatchField.H"
#include "Time.H"
...
template<class Type>
Foam::fileName
Foam::coconut_timeVaryingMappedFvPatchField<Type>::findFieldFile
(
    const word& timeName
) const
{
...
template<class Type>
void Foam::coconut_timeVaryingMappedFvPatchField<Type>::checkTable()
{
    // Initialise
    if (mapperPtr_.empty())
    {
	Info << "Initialize CheckTable" << endl;
        ...
        if (debug)
        {
            Info<< "coconut_timeVaryingMappedFvPatchField :"
    ...
    //label lo =time().value()/0.00002 + 1; //MATHIEU
    label lo = -1;
    label hi = -1;
...
template<class Type>
Foam::coconut_timeVaryingMappedFvPatchField<Type>::coconut_timeVaryingMappedFvPatchField
(
    const fvPatch& p,
...
template<class Type>
Foam::coconut_timeVaryingMappedFvPatchField<Type>::
coconut_timeVaryingMappedFvPatchField
(
    const coconut_timeVaryingMappedFvPatchField<Type>& ptf
)
:
    patch_(ptf.patch_),
...
template<class Type>
void Foam::coconut_timeVaryingMappedFvPatchField<Type>::autoMap
(
...
template<class Type>
void Foam::coconut_timeVaryingMappedFvPatchField<Type>::rmap
(
    const coconut_timeVaryingMappedFvPatchField<Type>& tiptf,
...
template<class Type>
Foam::tmp<Foam::Field<Type>> Foam::coconut_timeVaryingMappedFvPatchField<Type>::map()
{
    checkTable();
...
template<class Type>
void Foam::coconut_timeVaryingMappedFvPatchField<Type>::write
(
    Ostream& os
) const
{
