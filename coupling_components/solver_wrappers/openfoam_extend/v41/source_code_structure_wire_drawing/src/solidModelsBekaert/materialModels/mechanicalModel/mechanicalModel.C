    ...
    planeStress_(lookup("planeStress"))
{
    ...
    // Create the mechanical law
    mechanicalLawPtr_ =
        mechanicalLaw::New("law", mesh, subDict("mechanical"), 0);
...
Foam::tmp<Foam::volScalarField> Foam::mechanicalModel::RhieChowScaleFactor() const
{
    return mechanicalLawPtr_->RhieChowScaleFactor();
}
...
//MATHIEU
void Foam::mechanicalModel::resetYieldStress()
{
	mechanicalLawPtr_->resetYieldStress();
}
...
{
    return mechanicalLawPtr_->newDeltaT();
}
