...
#include "elastoPlasticBatheHillEvolving.H"
...
namespace Foam
{
    defineTypeNameAndDebug(elastoPlasticBatheHillEvolving, 0);
    addToRunTimeSelectionTable
    (
        mechanicalLaw, elastoPlasticBatheHillEvolving, dictionary
    );

// * * * * * * * * * * * * * * Static Members  * * * * * * * * * * * * * * * //

    scalar elastoPlasticBatheHillEvolving::sqrtTwoOverThree_ = ::sqrt(2.0/3.0);

    scalar elastoPlasticBatheHillEvolving::sqrtOneOverThree_ = ::sqrt(1.0/3.0);

    scalar elastoPlasticBatheHillEvolving::sqrtThreeOverTwo_ = ::sqrt(3.0/2.0);

    Eigen::Matrix2d elastoPlasticBatheHillEvolving::I2_ =
...
Foam::volSymmTensorField& Foam::elastoPlasticBatheHillEvolving::RTensor()
{
    if (!RTensorPtr_)
    {
        FatalErrorIn
        (
            ...
            "Foam::elastoPlasticBatheHillEvolving::RTensor()"
...
Foam::elastoPlasticBatheHillEvolving::RTensor() const
{
    if (!RTensorPtr_)
    {
        FatalErrorIn
...
Foam::volTensorField& Foam::elastoPlasticBatheHillEvolving::FpInv()
{
    if (!FpInvPtr_)
    {
        FatalErrorIn
        (
            "Foam::volTensorField& "
            "Foam::elastoPlasticBatheHillEvolving::FpInv()"
        )   << "pointer not set" << abort(FatalError);
    }
...
const Foam::volTensorField& Foam::elastoPlasticBatheHillEvolving::FpInv() const
{
    if (!FpInvPtr_)
    {
        FatalErrorIn
...
Foam::volSymmTensorField& Foam::elastoPlasticBatheHillEvolving::Dp()
{
    if (!DpPtr_)
    {
        FatalErrorIn
        (
            "Foam::volSymmTensorField& "
            "Foam::elastoPlasticBatheHillEvolving::Dp()"
        )   << "pointer not set" << abort(FatalError);
    }
...
const Foam::volSymmTensorField& Foam::elastoPlasticBatheHillEvolving::Dp() const
{
    if (!DpPtr_)
    {
        FatalErrorIn
...
Foam::volScalarField& Foam::elastoPlasticBatheHillEvolving::epsilonPEq()
{
    if (!epsilonPEqPtr_)
    {
        FatalErrorIn
        (
            "Foam::volScalarField& "
            "Foam::elastoPlasticBatheHillEvolving::epsilonPEq()"
        )   << "pointer not set" << abort(FatalError);
    }
...
Foam::elastoPlasticBatheHillEvolving::epsilonPEq() const
{
    if (!epsilonPEqPtr_)
    {
        FatalErrorIn
...
Foam::volScalarField& Foam::elastoPlasticBatheHillEvolving::activeYield()
{
    if (!activeYieldPtr_)
    {
        FatalErrorIn
        (
            "Foam::volScalarField& "
            "Foam::elastoPlasticBatheHillEvolving::activeYield()"
        )   << "pointer not set" << abort(FatalError);
    }
...
const Foam::volScalarField&
Foam::elastoPlasticBatheHillEvolving::activeYield() const
{
    if (!activeYieldPtr_)
    {
        FatalErrorIn
...
Foam::volSymmTensorField& Foam::elastoPlasticBatheHillEvolving::yieldStress()
{
    if (!yieldStressPtr_)
    {
        FatalErrorIn
        (
            "Foam::volSymmTensorField& "
            "Foam::elastoPlasticBatheHillEvolving::yieldStress()"
        )   << "pointer not set" << abort(FatalError);
    }
...
const Foam::volSymmTensorField&
Foam::elastoPlasticBatheHillEvolving::yieldStress() const
{
    if (!yieldStressPtr_)
    {
        FatalErrorIn
...
Foam::symmTensor Foam::elastoPlasticBatheHillEvolving::calculateStress
(
    const symmTensor& Ee
)
{
...
Foam::symmTensor Foam::elastoPlasticBatheHillEvolving::logm(const symmTensor& T)
{
...
Foam::symmTensor Foam::elastoPlasticBatheHillEvolving::expm(const symmTensor& T)
{
...
void Foam::elastoPlasticBatheHillEvolving::smallStrainReturnMap
(
    symmTensor& TTrial,
    tensor& FpInv,
...
)
{
    ...
    // Recalculate all dependancies on RTensor_
    //symmTensor RTensor =
    //    RTensor0_ + (RTensorSat_ - RTensor0_)
    //   *(1.0 - Foam::exp(-RTensorRate_*epsilonPEqOld));
    symmTensor RTensor = symmTensor::zero;
    RTensor.xx() =
        RTensor0_.xx()
      + (RTensorSat_.xx() - RTensor0_.xx())
       *(1.0 - Foam::exp(-RTensorRate_.xx()*epsilonPEqOld));
    RTensor.xy() =
        RTensor0_.xy()
      + (RTensorSat_.xy() - RTensor0_.xy())
       *(1.0 - Foam::exp(-RTensorRate_.xy()*epsilonPEqOld));
    RTensor.xz() =
        RTensor0_.xz()
      + (RTensorSat_.xz() - RTensor0_.xz())
       *(1.0 - Foam::exp(-RTensorRate_.xz()*epsilonPEqOld));
    RTensor.yy() =
        RTensor0_.yy()
      + (RTensorSat_.yy() - RTensor0_.yy())
       *(1.0 - Foam::exp(-RTensorRate_.yy()*epsilonPEqOld));
    RTensor.yz() =
        RTensor0_.yz()
      + (RTensorSat_.yz() - RTensor0_.yz())
       *(1.0 - Foam::exp(-RTensorRate_.yz()*epsilonPEqOld));
    RTensor.zz() =
        RTensor0_.zz()
      + (RTensorSat_.zz() - RTensor0_.zz())
       *(1.0 - Foam::exp(-RTensorRate_.zz()*epsilonPEqOld));

    alpha1_ =
    (
        (1.0/Foam::sqr(RTensor.yy()))
      + (1.0/Foam::sqr(RTensor.zz())) - (0.5/Foam::sqr(RTensor.xx()))
    );
    alpha2_ = ((3.0/2.0)*(1.0/Foam::sqr(RTensor.xx())));
    alpha3_ = (0.5/Foam::sqr(RTensor.xy()));
    alpha4_ = (0.5/Foam::sqr(RTensor.yz()));
    alpha5_ = (0.5/Foam::sqr(RTensor.xz()));
    gamma1_ =
        (3.0/2.0)
       *(
           (1.0/Foam::sqr(RTensor.zz())) - (1.0/Foam::sqr(RTensor.yy()))
        );
    ...
    if (phi > 0.0)
    {
        ...
        for (int outerIteration = 0; outerIteration < 100; outerIteration++)
        {
            ...
            // keeps track of how much RTensor changed, if it doesnt change much
            // can exit outer loop
            symmTensor RTensorNew = symmTensor::zero;
            RTensorNew.xx() =
                RTensor0_.xx()
              + (RTensorSat_.xx() - RTensor0_.xx())
               *(1.0 - Foam::exp(-RTensorRate_.xx()*epsilonPEqOld));
            ...
            alpha1_ =
                (
                    (1.0/Foam::sqr(RTensor.yy()))
                  + (1.0/Foam::sqr(RTensor.zz()))
                  - (0.5/Foam::sqr(RTensor.xx()))
                );
            alpha2_ = ((3.0/2.0)*(1.0/Foam::sqr(RTensor.xx())));
            alpha3_ = (0.5/Foam::sqr(RTensor.xy()));
            alpha4_ = (0.5/Foam::sqr(RTensor.yz()));
            ...
            else if (outerIteration > 100)
            {
                WarningIn(type() + "::smallStrainReturnMap(...)")
                    << "RTensor loop did not converge..."
                    << endl;
            }
...
Foam::elastoPlasticBatheHillEvolving::elastoPlasticBatheHillEvolving
(
    const word& name,
    const fvMesh& mesh,
...
:
    ...
    (
        ...
        ? symmTensor
        (
            1.0, sqrtOneOverThree_, sqrtOneOverThree_,
            1.0, sqrtOneOverThree_,
            1.0
        )
      : dict.lookup("RTensor0")
    ),
    RTensorSat_
    (
        plasticIsotropy_
        ? symmTensor::zero
      : dict.lookup("RTensorSat")
    ),
    RTensorRate_
    (
        plasticIsotropy_
        ? symmTensor::zero
      : dict.lookup("RTensorRate")
    ),
    // P-Lu plasticity parameters
    alpha1_
    (
        (1.0/Foam::sqr(RTensor0_.yy()))
      + (1.0/Foam::sqr(RTensor0_.zz()))
      - (0.5/Foam::sqr(RTensor0_.xx()))
    ),
    alpha2_((3.0/2.0)*(1.0/Foam::sqr(RTensor0_.xx()))),
    alpha3_(0.5/Foam::sqr(RTensor0_.xy())),
    alpha4_(0.5/Foam::sqr(RTensor0_.yz())),
    alpha5_(0.5/Foam::sqr(RTensor0_.xz())),
    gamma1_
    (
        (3.0/2.0)
       *((1.0/Foam::sqr(RTensor0_.zz())) - (1.0/Foam::sqr(RTensor0_.yy())))
    ),
    DStar12_(2, 2),
    PStar12_(2, 2),
    D12_(2, 2),
      ...
      damageLawPtr_(NULL)
{
    ...
    (
        RTensorPtr_,
        "RTensor",
        dimensionedSymmTensor("one", dimless, RTensor0_)
    );
    ...
    if (gMin(mag(FpInv().internalField())) < SMALL)
    {
        WarningIn
        (
            "elastoPlasticBatheHillEvolving::elastoPlasticBatheHillEvolving()"
...
Foam::elastoPlasticBatheHillEvolving::~elastoPlasticBatheHillEvolving()
{
    CleanFieldPtr<symmTensor>(RTensorPtr_, "RTensor");
...
Foam::elastoPlasticBatheHillEvolving::rho() const
{
...
Foam::tmp<Foam::volScalarField> Foam::elastoPlasticBatheHillEvolving::E() const
{
    if (elasticIsotropy_)
    {
        return tmp<volScalarField>
...
Foam::tmp<Foam::volScalarField> Foam::elastoPlasticBatheHillEvolving::nu() const
{
    if (elasticIsotropy_)
    {
        return tmp<volScalarField>
...
Foam::tmp<Foam::volScalarField>
Foam::elastoPlasticBatheHillEvolving::RhieChowScaleFactor() const
{
...
void Foam::elastoPlasticBatheHillEvolving::correct(volSymmTensorField& tau)
{
    ...
    symmTensorField& RTensorI = RTensor().internalField();
    ...
    forAll(F.boundaryField(), patchI)
    {
        if (mesh.boundaryMesh()[patchI].type() != "empty")
        {
            ...
            symmTensorField& RTensorP = RTensor().boundaryField()[patchI];
...
Foam::scalar Foam::elastoPlasticBatheHillEvolving::residual()
{
    return
        gMax
        (
...
void Foam::elastoPlasticBatheHillEvolving::correct(surfaceSymmTensorField& tau)
{
    notImplemented
    (
        "elastoPlasticBatheHillEvolving::correct(surfaceSymmTensorField& tau)"
    );
}


Foam::tmp<Foam::volScalarField>
Foam::elastoPlasticBatheHillEvolving::plasticDissipationRate() const
{
...
Foam::scalar Foam::elastoPlasticBatheHillEvolving::newDeltaT() const
{
...
void Foam::elastoPlasticBatheHillEvolving::updateYieldStress()
{
