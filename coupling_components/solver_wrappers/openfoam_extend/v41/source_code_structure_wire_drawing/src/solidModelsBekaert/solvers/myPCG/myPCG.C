...
namespace Foam
{
    ...
    lduSolver::addsymMatrixConstructorToTable<myPCG>
...
Foam::lduSolverPerformance Foam::myPCG::solve
(
    scalarField& x,
    const scalarField& b,
...
) const
{
   ...
   // Info << "initialResidual " << solverPerf.initialResidual() << endl;
	...
	//Info << "nIterations " << solverPerf.nIterations() << endl;
    }
