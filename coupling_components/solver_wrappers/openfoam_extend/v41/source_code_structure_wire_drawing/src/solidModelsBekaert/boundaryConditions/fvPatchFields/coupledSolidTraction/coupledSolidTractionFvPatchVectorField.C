...
// coupledSolidTractionFvPatchVectorField::originalPatchField() const
// {
...
coupledSolidTractionFvPatchVectorField::coupledSolidTractionFvPatchVectorField
(
    const fvPatch& p,
...
coupledSolidTractionFvPatchVectorField::coupledSolidTractionFvPatchVectorField
(
    const coupledSolidTractionFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
    ...
    // curTimeIndex_(-1)
{
    ...
    //         "coupledSolidTractionFvPatchVectorField\n"
    //         "(\n"
    //         "    const coupledSolidTractionFvPatchVectorField<Type>& ptf,\n"
    //         "    const fvPatch& p,\n"
    //         "    const DimensionedField<Type, volMesh>& iF,\n"
    //         "    const fvPatchFieldMapper& mapper\n"
    //         ")\n"
...
// coupledSolidTractionFvPatchVectorField::lookupShadowPatchField
// (
//     const word& name,
//     const LookupField*,
//     const LookupType*
...
// template<class Type>
// const coupledSolidTractionFvPatchVectorField<Type>&
// coupledSolidTractionFvPatchVectorField::shadowPatchField() const
// {
//     // Lookup neighbour field
//     typedef GeometricField<Type, fvPatchField, volMesh> GeoField;

//     return refCast<const coupledSolidTractionFvPatchVectorField<Type> >
//     (
...
// tmp<Field<Type> > coupledSolidTractionFvPatchVectorField::
...
tmp<Field<vector> > coupledSolidTractionFvPatchVectorField::
patchNeighbourField
(
    const word& name
) const
{
    ...
    notImplemented("patchNeighbourField");

    return tmp<vectorField>(new vectorField());
}


void coupledSolidTractionFvPatchVectorField::initEvaluate
(
...
)
{
    if (debug)
    {
        Info << "In coupledSolidTractionFvPatchVectorField::initEvaluate() on "
...
void coupledSolidTractionFvPatchVectorField::evaluate
(
...
void coupledSolidTractionFvPatchVectorField::updateCoeffs()
{
    if (debug)
    {
        Info << "In coupledSolidTractionFvPatchVectorField::updateCoeffs() on "
            << this->dimensionedInternalField().name()
            << " in " << this->patch().boundaryMesh().mesh().name()
            << " " << this->updated() << endl;
    }
...
tmp<Field<vector> > coupledSolidTractionFvPatchVectorField::snGrad() const
{
    ...
    return fvPatchField<vector>::snGrad();
}


// Initialise neighbour processor internal cell data
void coupledSolidTractionFvPatchVectorField::initInterfaceMatrixUpdate
(
...
void coupledSolidTractionFvPatchVectorField::updateInterfaceMatrix
(
    const scalarField& psiInternal,
    scalarField& result,
    const lduMatrix&,
...
// Write
void coupledSolidTractionFvPatchVectorField::write(Ostream& os) const
{
