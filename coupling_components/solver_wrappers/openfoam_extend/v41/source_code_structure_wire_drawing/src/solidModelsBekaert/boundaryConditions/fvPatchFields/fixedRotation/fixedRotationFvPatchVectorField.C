    ...
    originSeries_()
{
    ...
    if (fieldName_ != "U" && fieldName_ != "DU")
    {
        FatalErrorIn("void fixedRotationFvPatchVectorField")
...
void fixedRotationFvPatchVectorField::updateCoeffs()
{
    ...
    if (incremental)
    {
        const volVectorField& U =
            patch().boundaryMesh().mesh().objectRegistry::lookupObject
            <
                volVectorField
            >("U");

        disp -= U.oldTime().boundaryField()[patch().index()];
    }
...
//     if
//     (
//         mesh.objectRegistry::foundObject<pointVectorField>("point" + fieldName_)
//     )
//     {
//         pointVectorField& pointDUField =
...
//         // Total disp
//         const pointVectorField& pointUField =
//             mesh.objectRegistry::lookupObject<pointVectorField>("pointU");

//         fixedValuePointPatchVectorField& pointDU =
//             refCast<fixedValuePointPatchVectorField>
//             (
//                 pointDUField.boundaryField()[patch().index()]
//             );

//         vectorField newPatchPoints =
//             (rotMat & (origPatchPoints_ - rotationOrigin_)) + rotationOrigin_;
...
//             pointDisp[pointi] -= pointUField[meshPointi];
//         }
