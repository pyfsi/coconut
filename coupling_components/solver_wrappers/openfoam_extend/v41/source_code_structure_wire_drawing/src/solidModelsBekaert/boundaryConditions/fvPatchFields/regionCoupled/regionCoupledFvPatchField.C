...
template<class Type>
const Foam::Field<Type>& regionCoupledFvPatchField<Type>::originalPatchField() const
{
...
template<class Type>
regionCoupledFvPatchField<Type>::regionCoupledFvPatchField
(
    const fvPatch& p,
...
regionCoupledFvPatchField<Type>::lookupShadowPatchField
(
    const word& name,
    const LookupField*,
    const LookupType*
...
regionCoupledFvPatchField<Type>::shadowPatchField() const
{
    // Lookup neighbour field
    typedef GeometricField<Type, fvPatchField, volMesh> GeoField;

    return refCast<const regionCoupledFvPatchField<Type> >
    (
...
template<class Type>
tmp<Field<Type> > regionCoupledFvPatchField<Type>::patchNeighbourField() const
{
...
template<class Type>
tmp<Field<Type> > regionCoupledFvPatchField<Type>::patchNeighbourField
(
    const word& name
) const
{
...
template<class Type>
void regionCoupledFvPatchField<Type>::initEvaluate
(
...
)
{
    if(debug)
    {
        Info << "In regionCoupledFvPatchField<Type>::initEvaluate() on "
...
template<class Type>
void regionCoupledFvPatchField<Type>::evaluate
(
...
template<class Type>
tmp<Field<Type> > regionCoupledFvPatchField<Type>::snGrad() const
{
...
template<class Type>
void regionCoupledFvPatchField<Type>::initInterfaceMatrixUpdate
(
...
) const
{
    ...
    else
    {
        FatalErrorIn
        (
            "regionCoupledFvPatchField<Type>::initInterfaceMatrixUpdate"
...
template<class Type>
void regionCoupledFvPatchField<Type>::updateInterfaceMatrix
(
    const scalarField& psiInternal,
    scalarField& result,
    const lduMatrix&,
...
) const
{
    ...
    else
    {
        FatalErrorIn
        (
            "regionCoupledFvPatchField<Type>::updateInterfaceMatrix"
...
// Write
template<class Type>
void regionCoupledFvPatchField<Type>::write(Ostream& os) const
{
