...
void timeVaryingMappedSolidTractionFvPatchVectorField::checkTable()
{
    ...
    if ((lo != startSampleTime_)||(findSampleTimeMultiple_))
    {
        startSampleTime_ = lo; 
	  ...
	  IOField<scalar> pressureVals
            ...
            startSampledPressureValues_ = interpolate(pressureVals);
           
	// Reread vector values and interpolate	    
          IOField<vector> tractionVals
             (
                 IOobject
                 (
       	    ...
       	    startSampledTractionValues_ = interpolate(tractionVals);
	}
    }

    if ((hi != endSampleTime_)||(findSampleTimeMultiple_))
    {
        endSampleTime_ = hi;
        ...
        else
        {
          ...
          // Reread scalar values and interpolate
     	  IOField<scalar> pressureVals
            ...
            endSampledPressureValues_ = interpolate(pressureVals);
	  ...
	  IOField<vector> tractionVals
	   ...
	   endSampledTractionValues_ = interpolate(tractionVals);
