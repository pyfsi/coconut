...
//         W /= sumW;
        ...
        for (label i=0; i<allPoints.size(); i++)
        {
            ...
            refLengthPoints[pI] = allPoints[i];
        ...
        for (label i=0; i<allMirrorPoints.size(); i++)
        {
            ...
            refLengthPoints[pI] = allMirrorPoints[i];

            pI++;
        }

        scalar refLength = boundBox(refLengthPoints, false).mag();
