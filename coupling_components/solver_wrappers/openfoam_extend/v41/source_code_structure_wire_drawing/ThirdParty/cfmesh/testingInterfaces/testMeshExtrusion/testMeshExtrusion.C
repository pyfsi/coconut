...
#   include "createTime.H"
    ...
    const vector axis(0., 0.5, 1.5);
    const word pName = "bottomEmptyFaces";

    extrude2DMesh ext(pmg);
    ext.setExtrusionVector(axis);
    ext.setExtrusionPatch(pName);
    ext.setNumberOfSubdivisions(50);

    ext.generateExtrudedMesh();
