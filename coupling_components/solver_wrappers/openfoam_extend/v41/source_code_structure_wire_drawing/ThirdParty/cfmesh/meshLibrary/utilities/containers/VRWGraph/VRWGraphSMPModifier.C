...
void VRWGraphSMPModifier::optimizeMemoryUsage()
{
    ...
    # endif
    {
        ...
        # pragma omp single
        {
            nRows.setSize(omp_get_num_threads());
            nEntries.setSize(omp_get_num_threads());
        }
...
{
    graph_.data_ = og.data_;
    graph_.rows_ = og.rows_;
}
