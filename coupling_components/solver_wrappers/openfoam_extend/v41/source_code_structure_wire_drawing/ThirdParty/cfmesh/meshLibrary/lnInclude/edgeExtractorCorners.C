...
void edgeExtractor::faceEvaluator::calculateNeiPatchesParallel()
{
    ...
    const labelLongList& fPatches = extractor_.facePatch_;
...
void edgeExtractor::faceEvaluator::calculateNeiPatchesParallelNewPatches()
{
    ...
    const labelLongList& fPatches = *newBoundaryPatchesPtr_;
...
(
    const labelLongList& newBoudaryPatches
)
{
...
void edgeExtractor::cornerEvaluator::createParallelAddressing()
{
    ...
    const labelLongList& facePatch = extractor_.facePatch_;
    ...
    const labelLongList& globalLabel = mse.globalBoundaryPointLabel();
