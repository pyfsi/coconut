...
)
{
    ...
    label nCells(0);
    labelLongList newCellLabel(cells.size());
    ...
    //- this moves the newly-created bnd faces to the end of the list
    ...
    //- remove marked faces from the mesh
