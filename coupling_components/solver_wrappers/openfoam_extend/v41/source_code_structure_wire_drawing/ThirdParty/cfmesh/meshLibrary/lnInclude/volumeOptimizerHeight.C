...
const vector volumeOptimizerHeight::dirVecs[8] =
    {
        vector(-1.0, -1.0, -1.0),
        vector(1.0, -1.0, -1.0),
        vector(-1.0, 1.0, -1.0),
...
volumeOptimizerHeight::volumeOptimizerHeight(partTetMeshSimplex& simplex)
:
    simplexSmoother(simplex)
{}

volumeOptimizerHeight::~volumeOptimizerHeight()
{}

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
// Member functions

void volumeOptimizerHeight::optimizeNodePosition(const scalar tol)
{
    ...
    {
        //- some exception has caused problems
        p = pOrig;
    }
