...
! Inputs
!
      real*8, intent(in)    :: Fnew(3,3),Fold(3,3)        !Old and New deformation gradients
      real*8, intent(in)    :: props(11)                  !Material properties (see below)
      real*8, intent(in)    :: statOld(25)               !Old state veriables and stress components
!
! Outputs
!
      real*8, intent(out)    :: statNew(25), sNew(6)      !New state variables and new Snew components
!
!
!
!
...
!
      ...
      axang0(3)=statOld(23)
      axang0(4)=statOld(24)
      call axang2rot(axang0,ROTORI0)   !Initial colony orientation (Colony->Ref)
!
...
! 
      ...
      statNew(3)=axang(1)    !Gorde orientazio berria
      statNew(4)=axang(2)
      statNew(5)=axang(3)
      statNew(6)=axang(4)
      !
