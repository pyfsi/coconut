...
animation_figure_temperature = AnimationFigure()  # figure for pressure animations
animation_figure_heat_flux = AnimationFigure()  # figure for coordinate animations
