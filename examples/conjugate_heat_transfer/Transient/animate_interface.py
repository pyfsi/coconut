...
# Animate interface temperature & heat flux
Animation2d(sx, 'initial_coordinates', 'temperature', x_component='x')
plt.show()

Animation2d(sy, 'initial_coordinates', 'heat_flux', x_component='x')
plt.show()
