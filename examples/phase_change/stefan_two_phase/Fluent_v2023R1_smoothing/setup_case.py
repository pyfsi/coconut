...
solver_1 = 'pc_fluent.v2023R1'
solver_2 = 'pc_fluent.v2023R1'
cfd_dir_1 = 'CFD_1'
cfd_dir_2 = 'CFD_2'
...
shutil.copytree('../setup_files/solid_smoothing', cfd_dir_1)
...
shutil.copytree('../setup_files/liquid_smoothing', cfd_dir_2)
