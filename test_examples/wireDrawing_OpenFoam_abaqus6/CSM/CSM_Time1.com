...
options = {
    ...
    'thermal':OFF,
    'tmpdir':'/tmp/Tango31183/CSM',
    'tracer':OFF,
    'user':'usr.f',
    'usub_lib_dir':'/lusers/temp/mathieu/PycharmProjects/coconut/test_examples/wireDrawing_OpenFoam_abaqus6/CSM/libusr/',
    'visco':OFF,
}
