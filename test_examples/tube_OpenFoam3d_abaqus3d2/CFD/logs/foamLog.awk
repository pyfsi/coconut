...
function resetCounters() {
    cellDisplacementxCnt=0
    cellDisplacementxFinalResCnt=0
    cellDisplacementxItersCnt=0
    cellDisplacementyCnt=0
    cellDisplacementyFinalResCnt=0
    cellDisplacementyItersCnt=0
    cellDisplacementzCnt=0
    cellDisplacementzFinalResCnt=0
    cellDisplacementzItersCnt=0
    contCumulativeCnt=0
    contGlobalCnt=0
    contLocalCnt=0
    CourantMaxCnt=0
