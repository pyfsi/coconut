...
if reverse:
    common_path = '../Transient/qn_test/TFFB/'
else:
    common_path = '../Transient/qn_test/TFFB/'
f = '/case_results.pickle'

if debug:
    case_paths = ['q0/0.1' + f, 'q1/0.1' + f, 'q3/0.1' + f, 'q5/0.1' + f]
    legend_entries = ['q = 0', 'q = 1', 'q = 3', 'q = 5']
else:
...
animation_figure_residual = AnimationFigure() # figure for residual animations
colors = ['tab:blue', 'tab:orange', 'tab:green', 'tab:red']
line_styles = ['-', '--', ':', '-.']
sol, itf, var, uni, ani_fig = 'solution_r', 'interface_x', 'temperature', 'K', animation_figure_residual
...
animation_figure_residual.make_animation(interval=2000)
#animation_figure_residual.make_plot(50)

save = False
animation_figure = animation_figure_residual
movie_name = './figures/residual.mp4'
if save:
