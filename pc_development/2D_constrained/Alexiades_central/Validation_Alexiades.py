...
# Read and load data
sim_file = 'CFD_2/report-file_clu33.out'
validation_path = '../2D_post_processing/Alexiades_validation/'

pp = PostProcess('case_results_clu33.pickle')
...
plt.legend(handles=[line_val_100, line_sim_100, line_val_200, line_sim_200, line_val_450, line_val_700])
