...
# Plots (simulation data starting from t_0 tot t_end)
dt = 0.01 # s
t_0 = 1 # s
t_end = 800 # s
ts_0 = M.ceil(t_0/dt)
ts_end = M.ceil(t_end/dt)

# Liquid fraction
line_sim, = plt.plot(time_sim[ts_0:ts_end], LF_sim[ts_0:ts_end], '-k', label='Simulation')
...
line_sim, = plt.plot(time_sim[ts_0:ts_end], stream_max_sim[ts_0:ts_end], '-k', label='Simulation')
...
line_sim, = plt.plot(time_sim[ts_0:ts_end], stream_min_sim[ts_0:ts_end], '-k', label='Simulation')
...
# Maximum x-velocity
line_sim, = plt.plot(time_sim[ts_0:ts_end], u_max_sim[ts_0:ts_end], '-k', label='Simulation')
...
# Minimum x-velocity
line_sim, = plt.plot(time_sim[ts_0:ts_end], u_min_sim[ts_0:ts_end], '-k', label='Simulation')
...
# Maximum y-velocity
line_sim, = plt.plot(time_sim[ts_0:ts_end], v_max_sim[ts_0:ts_end], '-k', label='Simulation')
...
# Minimum y-velocity
line_sim, = plt.plot(time_sim[ts_0:ts_end], v_min_sim[ts_0:ts_end], '-k', label='Simulation')
