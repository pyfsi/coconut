...
# Read and load data
sim_file = 'CFD_2/report-file_explicit.out'
validation_path = '../2D_post_processing/Alexiades_validation/'

pp = PostProcess('case_results_explicit.pickle')
print(pp)
print("\n")
...
plt.legend(handles=[line_val_100, line_sim_100, line_val_200, line_sim_200, line_val_450, line_sim_450, line_val_700])
