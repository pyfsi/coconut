...
x_sim_100 = sx.get_values('coordinates', 'x')[1000,:].flatten()
y_sim_100 = sx.get_values('coordinates', 'y')[1000,:].flatten()
x_sim_200 = sx.get_values('coordinates', 'x')[2000,:].flatten()
y_sim_200 = sx.get_values('coordinates', 'y')[2000,:].flatten()
x_sim_450 = sx.get_values('coordinates', 'x')[4500,:].flatten()
y_sim_450 = sx.get_values('coordinates', 'y')[4500,:].flatten()
x_sim_700 = sx.get_values('coordinates', 'x')[7000,:].flatten()
y_sim_700 = sx.get_values('coordinates', 'y')[7000,:].flatten()
...
plt.xlim((0, 0.1))
plt.title('Validation of simulation: interface location')
