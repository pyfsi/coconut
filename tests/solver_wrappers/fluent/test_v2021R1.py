...
class TestSolverWrapperFluent2021R1Tube2D(fluent.TestSolverWrapperFluentTube2D):
    version = version
    setup_case = True


@unittest.skipUnless(solver_available(f'fluent.v{version}'), f'fluent.v{version} not available')
class TestSolverWrapperFluent2021R1Tube3D(fluent.TestSolverWrapperFluentTube3D):
    version = version
    setup_case = True
