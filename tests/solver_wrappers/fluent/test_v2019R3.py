...
class TestSolverWrapperFluent2019R3(TestSolverWrapperFluent2019R2):
    ...
    def test_solver_wrapper_fluent_2019R3_tube3d(self):
        ...
        if True:
            ...
            for i in range(data1n.size):
                self.assertAlmostEqual(data1n[i] - data2n[i], 0., delta=1e-3)
                # 1e-3 instead of 1e-14 because of strange Fluent behavior on restart
